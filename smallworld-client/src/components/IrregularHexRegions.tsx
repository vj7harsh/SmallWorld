...
export default function IrregularHexRegions() {
  ...
  return (
    <div className="w-screen h-screen flex overflow-hidden">
      <div className="w-64 shrink-0 p-4 flex flex-col gap-4 border-r border-black/10 dark:border-white/10 overflow-y-auto">
        <div className="flex flex-col gap-4">
          ...
          <button
            onClick={shuffle}
            className="px-3 py-1.5 rounded-xl bg-black/5 dark:bg-white/10 ring-1 ring-black/10 text-sm"
          >
            Shuffle
          </button>
        </div>
        <div className="text-xs opacity-70 space-y-1">
          <p>
            This generator creates an <b>irregular map</b> by randomly selecting tiles within a large axial field and then smoothing via a simple cellular-automata rule. Afterward, contiguous components are detected to form <b>regions</b>, each colored differently.
          </p>
          <p>
            Tips: Increase <b>Smooth</b> for chunkier landmasses; tweak <b>Density</b> to control land/water ratio. Hit <b>Shuffle</b> for a fresh world using a new seed.
          </p>
        </div>
        <div className="mt-auto text-xs opacity-70 grid grid-cols-2 gap-2">
          <div>
      ...
      <div className="flex-1 relative overflow-auto bg-neutral-900/5 dark:bg-neutral-800/40 ring-1 ring-black/5">
        <svg
          width={layout.width}
